...
export const UNIFIED_MODULES: UnifiedModule[] = [
  ...
  { key:"factory", zh:"工厂生产单", en:"Factory Work Orders", descriptionZh:"从已批准加工图创建真实工厂生产单，更新生产状态，并记录多笔运费和 Tracking。", descriptionEn:"Create real factory work orders from approved drawings, update production status, and record multiple freight charges and tracking numbers.", href:"/factory-work-orders", roles:["owner","sales"], status:"available" },
