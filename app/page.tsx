...
function PurchasingFinanceCenter(){
  const {data,loading}=useRealWorkbookData(),[tab,setTab]=useState<'orders'|'reconcile'|'remittance'|'expenses'>('orders'),[search,setSearch]=useState('');
