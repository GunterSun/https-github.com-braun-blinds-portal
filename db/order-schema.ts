...
export const orderItems = sqliteTable("order_items", {
  ...
  width: real("width"),
  height: real("height"),
  widthSixteenths: integer("width_sixteenths"),
  heightSixteenths: integer("height_sixteenths"),
  widthSourceValue: text("width_source_value").notNull().default(""),
  heightSourceValue: text("height_source_value").notNull().default(""),
  sourceUnit: text("source_unit").notNull().default("in"),
